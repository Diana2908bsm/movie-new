    ...
    <div class="movie-card">
        <div class="movie-card__inner">
            ...
            <div class="movie-card__box">
                ...
                <div class="movie-card__text">{{ movie.overview }}</div>
                <div class="movie-card__rating">{{ movie.vote_average }}</div>
                <div class="movie-card__btn">
                ...
                <div class="movie-card__list">
                    <ul v-for="(company, index) in movie.production_companies" :key="index">
